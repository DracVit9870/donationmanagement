...
import fetchAccounts from '@salesforce/apex/AgenttLWCExampleController.fetchAccounts'; 
import deletepolicyHolder from '@salesforce/apex/AgenttLWCExampleController.deletepolicyHolder';  
import { NavigationMixin } from 'lightning/navigation'; 
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
//import NAME_FIELD from '@salesforce/schema/Policy_Holder__c.name'; 
  
const COLUMNS = [   
    { label: 'Agent Id', fieldName: 'Id' },  
    { label: 'Name', fieldName: 'Name' },  
    { label: 'Phone', fieldName: 'Phone__c' },  
    { label: 'Register date', fieldName: 'Reg_Date__c' },
...
export default class HtmlTabAgent extends LightningElement {
